...
If create_output is 0, no output files will be created. If create_output is 1, two output files will
be created. susceptible.txt contains the number of susceptible humans after each simulation.
